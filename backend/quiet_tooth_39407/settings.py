"""
Django settings for quiet_tooth_39407 project.
...
ROOT_URLCONF = 'quiet_tooth_39407.urls'
...
WSGI_APPLICATION = 'quiet_tooth_39407.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_tooth_39407 API",
    "DESCRIPTION": "API documentation for quiet_tooth_39407 App",
    "VERSION": "v1",
}
